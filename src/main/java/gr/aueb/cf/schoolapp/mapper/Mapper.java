...
public class Mapper {
    ...
    public Teacher mapToTeacherEntity(TeacherInsertDTO insertDTO) {
        ...
        teacher.setIsActive(insertDTO.getIsActive());

        // Map fields from UserDTO
        UserInsertDTO userDTO = insertDTO.getUser();      // extract user insertDTO
        User user = new User();
        ...
        PersonalInfoInsertDTO personalInfoDTO = insertDTO.getPersonalInfo();      // extract personal info insertDTO
